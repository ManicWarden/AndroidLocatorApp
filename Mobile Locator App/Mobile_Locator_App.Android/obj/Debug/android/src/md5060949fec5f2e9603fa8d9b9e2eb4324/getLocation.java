package md5060949fec5f2e9603fa8d9b9e2eb4324;
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Mobile_Locator_App.Code.getLocation, Mobile_Locator_App.Android, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", getLocation.class, __md_methods);
	}
	...
	{
		super ();
		if (getClass () == getLocation.class)
			mono.android.TypeManager.Activate ("Mobile_Locator_App.Code.getLocation, Mobile_Locator_App.Android, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", "", this, new java.lang.Object[] {  });
	}

	public getLocation (android.content.Context p0)
	{
		super ();
		if (getClass () == getLocation.class)
			mono.android.TypeManager.Activate ("Mobile_Locator_App.Code.getLocation, Mobile_Locator_App.Android, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", "Android.Content.Context, Mono.Android, Version=0.0.0.0, Culture=neutral, PublicKeyToken=84e04ff9cfb79065", this, new java.lang.Object[] { p0 });
	}
